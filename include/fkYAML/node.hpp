...
public:
    ...
    /// @param[in] anchor_name An anchor name to get associated with this basic_node object.
    ...
    /// @brief Get the tag name associated to this basic_node object.
    /// @return The anchor name associated to the node. It may be empty.
    /// @sa https://fktn-k.github.io/fkYAML/api/basic_node/get_tag_name/
    const std::string& get_tag_name() const noexcept
    {
        return m_prop.tag;
    }
